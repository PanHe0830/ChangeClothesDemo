...
AChangeCharacter::AChangeCharacter()
{
...
void AChangeCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();

	HeadMesh->SetLeaderPoseComponent(GetMesh());
	ArmLeftMesh->SetLeaderPoseComponent(GetMesh());
	ArmRightMesh->SetLeaderPoseComponent(GetMesh());
...
void AChangeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AChangeCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AChangeCharacter::Look);
	}
	else
	{
...
void AChangeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
